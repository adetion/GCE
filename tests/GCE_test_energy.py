...
class GCE_TestEnergyCalculation:
    """Test the energy reward formula without running the full loop."""

    def GCE_test_perfect_prediction(self):
        base_reward = 10.0
        error_scale = 2.0
        error = 0.0
    ...
    def GCE_test_partial_prediction(self):
        base_reward = 10.0
        error_scale = 2.0
        error = 1.0
        reward = base_reward * max(0.0, 1.0 - error / error_scale)
    ...
    def GCE_test_bad_prediction(self):
        base_reward = 10.0
        error_scale = 2.0
        error = 3.0
        reward = base_reward * max(0.0, 1.0 - error / error_scale)
    ...
    def GCE_test_very_bad_prediction(self):
        base_reward = 10.0
        error_scale = 2.0
        error = 10.0
        reward = base_reward * max(0.0, 1.0 - error / error_scale)
